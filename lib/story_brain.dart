...
//TODO: Step 8 - Create a method called getStory() that returns the first storyTitle from _storyData.
  String getStory() {
    print('get story: ${{_storyData[_storyNumber].storyTitle}}');
    return _storyData[_storyNumber].storyTitle;
  }

//TODO: Step 11 - Create a method called getChoice1() that returns the text for the first choice1 from _storyData.
  String getChoice1(){
    print('get choice 1: ${{_storyData[_storyNumber].choice1}}');
    return _storyData[_storyNumber].choice1;
  }
//TODO: Step 12 - Create a method called getChoice2() that returns the text for the first choice2 from _storyData.
  String getChoice2(){
    print('get choice 2: ${{_storyData[_storyNumber].choice2}}');
...
//TODO: Step 20 - Download the story plan here: https://drive.google.com/uc?export=download&id=1KU6EghkO9Hf2hRM0756xFHgNaZyGCou3
    //PDF File downloaded and viewed by above link & now the time to implement if else code
...
//TODO: Step 27 - Create a method called buttonShouldBeVisible() which checks to see if storyNumber is 0 or 1 or 2 (when both buttons should show choices) and return true if that is the case, else it should return false.
 bool buttonShouldBeVisible(){
    print('Button story number: $_storyNumber');
    // You Should also check the _storyNumber > 3
